...
# код должен выполняться не выбрасывая исключенийa a
...
class Person():
    def use_transport(self, transport_class: Transport):
        transport_class.start_engine()
        transport_class.move()
        transport_class.stop()
        transport_class.stop_engine()
